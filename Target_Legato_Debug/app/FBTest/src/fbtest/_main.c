...
// Startup code for the executable 'fbtest'.
...
LE_SHARED le_log_SessionRef_t fbtest_exe_LogSession;
LE_SHARED le_log_Level_t* fbtest_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    fbtest_exe_LogSession = log_RegComponent("fbtest_exe", &fbtest_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_FBTestComponent.so");
